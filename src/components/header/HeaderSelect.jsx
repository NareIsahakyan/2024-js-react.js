...
const HeaderSelect = () => {
    ...
    return (
        ...
        <div className="selectBar">
            ...
            <div value="User" onClick={buttonClicked}><img src={user} width="14px" height="14px" /><span>{t("myProfile")}</span></div>
            <hr></hr>
            ...
            <hr></hr>
            <div value="LogOut" onClick={buttonClicked}><img src={logOut} width="14px" height="14px" /><span>{t("logOut")}</span></div>
        </div>
    )
}
